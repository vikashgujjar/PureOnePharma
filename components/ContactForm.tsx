          ...
          <div className="col-lg-6">
            <div className="cs_section_heading cs_style_1">
              <p className="cs_section_subtitle cs_accent_color">
                <span className="cs_shape_left"></span>GET IN TOUCH
              </p>
              <h2 className="cs_section_title">Connect With Pure One Pharma For Pharma Enquiries</h2>
            </div>
            ...
            <form className="cs_contact_form row cs_gap_y_30 home_form_area">
              ...
              <div className="col-md-6">
                <input type="text" name="subject" className="cs_form_field" placeholder="Company / Business Name" />
              </div>
              <div className="col-md-6">
                <input type="text" name="phone" className="cs_form_field" placeholder="Your phone" />
              </div>
              <div className="col-lg-12">
                <textarea rows={5} name="message" className="cs_form_field"
                  placeholder="Your enquiry (franchise, manufacturing, products, etc.)"></textarea>
              </div>
              <div className="col-lg-12">
                <button type="submit" className="cs_btn cs_style_1 cs_color_1">Send Enquiry</button>
              </div>
            </form>
          </div>
          <div className="col-lg-6">
            <div className="cs_solution_thumbnail cs_bg_filed" data-src="/assets/img/medical_solution_1.jpg">
            </div>
          </div>
        </div>
      </div>
