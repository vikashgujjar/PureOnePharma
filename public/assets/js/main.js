(function ($) {
  ...
  */
  ...
  function slickInit() {
    ...
    if ($('.cs_hero_slider_thumb').hasClass('slick-initialized')) {
      $('.cs_hero_slider_thumb').slick('unslick');
    }
    ...
    if ($('.cs_hero_slider_nav').hasClass('slick-initialized')) {
      $('.cs_hero_slider_nav').slick('unslick');
    }
  ...
  // Expose functions for Next.js route changes
